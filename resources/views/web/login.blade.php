    ...
    width: 100%;min-height: unset;padding: 50px 0px;background-attachment: unset;">
		<div class="login-outerbox text-center">
			...
			<div class="white-box">
				...
				@endif
				<form method='post' action="{{asset('')}}weblogin" id="login">
					{{ csrf_field() }}
                 ...
                 <input type="submit" class="btn btn-primary btn-block blue-btn">
				  	...
				  	<p class="text-right" style="margin: 15px 0 25px 0;"><a href="{{asset('forgetPassword')}}">Forgot Password?</a></p>
				  	...
				  	<div class="row">
				    	<div class="col-sm-6">
				      		<a href="redirect/facebook" class="btn btn-primary btn-block blue-btn facebook-btn">Login with Facebook</a>
				    	</div>
				    	<div class="col-sm-6">
				      		<a href="#" class="btn btn-primary btn-block blue-btn google-btn">Login with Google+</a>
				    	</div>
				    </div>
				</form>
			</div>
