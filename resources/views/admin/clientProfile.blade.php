...
<div class="row">
	<div class="col-md-12">
         ...
         <label>  <span style="color: #000; font-weight: bold;">Client Name :</span> <?= $userProfile->firstname ?> </label>
        <label>  <span style="color: #000; font-weight: bold;">Company Name :</span> <?= $userProfile->companyname ?> </label>
