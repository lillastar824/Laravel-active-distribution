  ...
  Users Listing
    ...
    <form role="form" method="post" id="admin_profile" action="{{url('bulkdeletion')}}" enctype="multipart/form-data">
        ...
        <div class="card-body">
          ...
          <td>  <a href="{{ url('clientProfile/'.$user->id) }}" class="view" style="text-decoration:none;"> View </a> </td>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form method='post' enctype='multipart/form-data' id='updateProfile' action='updateClientData'>
        {{csrf_field()}}
